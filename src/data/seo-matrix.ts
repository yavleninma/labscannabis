...
export const SEO_PAGES: SeoPage[] = [
  ...
  },
  {
    ...
    area: "pattaya",
    titleTemplate: {
      en: "Cannabis shop near me in Pattaya | Soi Hollywood | Labs Cannabis",
      ru: "Каннабис рядом со мной в Паттайе | Soi Hollywood",
      th: "ร้านกัญชาใกล้ฉัน พัทยา | Soi Hollywood",
      ar: "متجر قنب قريب مني في باتايا",
      zh: "芭提雅附近大麻店 | Soi Hollywood",
      ko: "파타야 근처 대마초 매장 | Soi Hollywood",
      ja: "パタヤ近くの大麻店 | Soi Hollywood",
    },
    h1Template: {
  ...
  },
  {
    ...
    area: "pattaya",
    titleTemplate: {
      en: "Best cannabis shop Pattaya | 4.8 Google listing | Labs Cannabis",
      ru: "Лучший каннабис-шоп Паттайя | 4.8 в Google",
      th: "ร้านกัญชาดีที่สุด พัทยา | 4.8 Google",
      ar: "أفضل متجر قنب باتايا | 4.8 Google",
      zh: "芭提雅最佳大麻店 | Google 4.8",
      ko: "파타야 최고 대마초 매장 | Google 4.8",
      ja: "パタヤ最高の大麻店 | Google 4.8",
    },
    h1Template: {
  ...
  },
  {
    ...
    area: "pattaya",
    titleTemplate: {
      en: "Labs Dispensary Pattaya | now Labs Cannabis on Soi Hollywood",
      ru: "Labs Dispensary Паттайя | теперь Labs Cannabis",
      th: "Labs Dispensary พัทยา | ตอนนี้ Labs Cannabis",
      ar: "Labs Dispensary باتايا | الآن Labs Cannabis",
      zh: "Labs Dispensary 芭提雅 | 现为 Labs Cannabis",
      ko: "Labs Dispensary 파타야 | 현재 Labs Cannabis",
      ja: "Labs Dispensaryパタヤ | 現在はLabs Cannabis",
    },
    h1Template: {
      en: "Labs Dispensary Pattaya — same Soi Hollywood shop, now Labs Cannabis",
      ru: "Labs Dispensary — тот же магазин на Soi Hollywood, теперь Labs Cannabis",
      th: "Labs Dispensary — ร้านเดิมบน Soi Hollywood ตอนนี้ Labs Cannabis",
      ar: "Labs Dispensary — نفس المتجر، الآن Labs Cannabis",
      zh: "Labs Dispensary — 同一家店，现名 Labs Cannabis",
      ko: "Labs Dispensary — 같은 매장, 현재 Labs Cannabis",
      ja: "Labs Dispensary — 同じ店、現在はLabs Cannabis",
    },
    keywords: {
