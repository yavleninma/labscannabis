...
export const AREA_ROUTES: Record<string, Partial<Record<Locale, AreaRoute>>> = {
  "walking-street": {
    ...
    ru: {
      ...
      description:
        "Дорога вглубь от арки Walking Street до 32 Pattaya 13 Alley: где обычно теряются, чем вечер отличается от дня и что называть водителю.",
      h1: "От Walking Street до двери в Pattaya 13 Alley",
      kicker: "Маршрут от Walking Street",
      intro:
