...
export default defineConfig({
   ...
   *
   * ЗАМЕР НА ЭТОМ ДЕРЕВЕ, сжатый транспорт, страница `/en/`:
   *   внешняя CSS: 11 882 B HTML + 6 843 B CSS = 18 725 B в ДВА запроса;
   *   инлайн:      18 494 B в ОДИН запрос.
   * То есть инлайн теперь не только снимает round-trip, но и суммарно на 231 B
   * легче — таблица похудела с 10,1 КБ gz до 6,8 КБ, и прежняя арифметика
   * («экономия round-trip ценой +0,6 КБ») перевернулась.
   *
